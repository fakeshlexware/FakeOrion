...
local FakeOrionLib = {}
function FakeOrionLib:MakeWindow(windowData)
	...
	Close_1.Position = UDim2.new(0.910628021, 0,0.184210524, 0)
	...
	function Tabs:MakeTab(tabData)
		...
		function Elements:AddLabel(labelData)
			...
			LabelIcon_1.Name = "LabelIcon"
			LabelIcon_1.Parent = LabelFrame_1
			LabelIcon_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
			LabelIcon_1.BackgroundTransparency = 1
			LabelIcon_1.BorderColor3 = Color3.fromRGB(0,0,0)
			LabelIcon_1.BorderSizePixel = 0
			LabelIcon_1.Position = UDim2.new(0.901818156, 0,0.166670576, 0)
			LabelIcon_1.Size = UDim2.new(0, 20,0, 17)
			LabelIcon_1.Image = "rbxassetid://14600209347"
